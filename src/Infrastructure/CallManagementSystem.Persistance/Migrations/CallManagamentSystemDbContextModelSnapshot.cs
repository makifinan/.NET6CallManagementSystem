...
namespace CallManagementSystem.Persistance.Migrations
{
    ...
    partial class CallManagamentSystemDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CallManagamentSystem.Domain.Entities.Authority", b =>
                {
                    ...
                    b.Property<DateTime>("GeneretedDate")
            ...
            modelBuilder.Entity("CallManagamentSystem.Domain.Entities.Request", b =>
                {
                    b.HasOne("CallManagamentSystem.Domain.Entities.DeveloperUser", "DeveloperUserT")
                        .WithMany("Requests")
                        .HasForeignKey("DeveloperUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CallManagamentSystem.Domain.Entities.ManagerUser", "ManagerUserT")
                        .WithMany("Requests")
                        .HasForeignKey("ManagerUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CallManagamentSystem.Domain.Entities.Priority", "PriorityT")
                        .WithMany("Requests")
                        .HasForeignKey("PriorityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CallManagamentSystem.Domain.Entities.Statu", "StatuT")
                        .WithMany("Requests")
                        .HasForeignKey("StatuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DeveloperUserT");

                    b.Navigation("ManagerUserT");

                    b.Navigation("PriorityT");
