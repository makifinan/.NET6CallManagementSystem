...
{
    public class NotificationTypeWriteRepository : WriteRepository<NotificationType>, INotificationTypeWriteRepository
    {
        public NotificationTypeWriteRepository(CallManagamentSystemDbContext context) : base(context)
        {
        }
    }
}
